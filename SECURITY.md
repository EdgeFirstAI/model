...
We take the security of EdgeFirst Model seriously. If you discover a security vulnerability, please report it responsibly.

**DO NOT** report security vulnerabilities through public GitHub issues.

Instead, please use one of the following methods:

1. **Email**: Send details to support@au-zone.com with subject line: "Security Vulnerability - EdgeFirst Model"
2. **GitHub Security Advisory**: Use the [private reporting feature](https://github.com/EdgeFirstAI/model/security/advisories/new)
