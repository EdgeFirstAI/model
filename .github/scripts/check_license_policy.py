...
def main():
    ...
    if passed and not review_required and not unknown:
        print("OK All dependencies comply with license policy!")
        print()
        sys.exit(0)
    elif passed and (review_required or unknown):
        print("WARNING License policy check passed, but manual review required:")
        if review_required:
        ...
        print("FAILED License policy check FAILED!")
